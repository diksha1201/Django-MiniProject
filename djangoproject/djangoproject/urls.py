...
from nimapp.views import ClientListCreateAPIView, ClientRetrieveUpdateDestroyAPIView, ProjectListCreateAPIView, ProjectRetrieveUpdateDestroyAPIView,UserDeleteAPIView, ProjectDeleteAPIView
